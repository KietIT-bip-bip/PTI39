from B3_4.models.student import Student
class Course:
    ...
    def __str__(self):
        ...
        Number of Lessons: {self.number_of_lessons}
        """
   ...
   #setter
    def set_name(self, name):
        if name and len(name)>=6: self.name = name
    ...
    def set_number_of_lessons(self, number_of_lessons):
        if 4 < number_of_lessons < 30: self.number_of_lessons = number_of_lessons
...
#---------------------
    ...
    def get_student_list_by_name(self, name):
        ...
        return [student for student in self.student_list if name.lower() in student.get_name().lower()]
